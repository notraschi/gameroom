...
public class checkers extends JPanel{
    ...
    public void calculatePossibleMoves(stone s){
        ...
        if(!pos.contains(ss) && !oppPos.contains(ss)) {
            ...
            if(!pos.contains(ss) && !oppPos.contains(ss) && ss.x>=0 && ss.x<290 && ss.y<290 && ss.y>=0) {
                stone dot1 = new stone(ss.x, ss.y, true);
                moveDot.add(dot1);
    ...
    private void checkCombo (stone s, boolean damone, String cd, stone sss, String exC) {
        ...
        if(!pos.contains(ts) && oppPos.contains(ts) && !pos.contains(ss) && !oppPos.contains(ss) && !exC.equals("tl") && ss.x>=0 && ss.x<290 && ss.y<290 && ss.y>=0) {
            if (cd.equals("tl")){
                comboKillsTL.add(ts);
        ...
        if(!pos.contains(ts) && oppPos.contains(ts) && !pos.contains(ss) && !oppPos.contains(ss) && !exC.equals("tr") && ss.x>=0 && ss.x<290 && ss.y<290 && ss.y>=0) {
            if (cd.equals("tl")){
                comboKillsTL.add(ts);
            } else if (cd.equals("tr")){
                comboKillsTR.add(ts);
        ...
        if (damone) {                                                                                                                    //bl2
            ...
            ss = new stone((Math.floor(s.x/blocksize)-2)*blocksize, (Math.floor(s.y/blocksize)+2)*blocksize); //where we end up after combo
            if(!pos.contains(ts) && oppPos.contains(ts) && !pos.contains(ss) && !oppPos.contains(ss) && !exC.equals("bl") && ss.x>=0 && ss.x<290 && ss.y<290 && ss.y>=0) {
                if (cd.equals("tl")){
                    comboKillsTL.add(ts);
                } else if (cd.equals("tr")){
                    comboKillsTR.add(ts);
            ...
            ss = new stone((Math.floor(s.x/blocksize)+2)*blocksize, (Math.floor(s.y/blocksize)+2)*blocksize); //where we end up after combo
            if(!pos.contains(ts) && oppPos.contains(ts) && !pos.contains(ss) && !oppPos.contains(ss) && !exC.equals("br") && ss.x>=0 && ss.x<290 && ss.y<290 && ss.y>=0) {
                if (cd.equals("tl")){
                    comboKillsTL.add(ts);
                } else if (cd.equals("tr")){
                    comboKillsTR.add(ts);
